...
app.post('/login', (req,res) => {
    ...
    if (req.body.Password.length < 8) // Object.length returns size of JSON object

    {
        res.status(401).send('Invalid Password. Password Should be of at Least 8 Characters')
    }
